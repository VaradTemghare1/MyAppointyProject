...
func main() {
	...
	defer cancel()
	client, _ := mongo.NewClient(options.Client().ApplyURI("mongodb+srv://VaradTemghare:Varad@123@cluster0.t4iso.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"))
